    ...
    struct lc3_ltpf_hp50_state *hp50, const int16_t *x, int16_t *y, int n)
{
    ...
    for (int i = 0; i < 5*n; i += 5) {
        ...
        (void)(un = vmull_s16(    vld1_s16(xn), vld1_s16(hn))), (void)(xn += 4), hn += 4;
        (void)(un = vmlal_s16(un, vld1_s16(xn), vld1_s16(hn))), (void)(xn += 4), hn += 4;
        (void)(un = vmlal_s16(un, vld1_s16(xn), vld1_s16(hn))), (void)(xn += 4), hn += 4;
        (void)(un = vmlal_s16(un, vld1_s16(xn), vld1_s16(hn))), (void)(xn += 4), hn += 4;
        (void)(un = vmlal_s16(un, vld1_s16(xn), vld1_s16(hn))), (void)(xn += 4), hn += 4;
...
LC3_HOT static inline float neon_dot(const int16_t *a, const int16_t *b, int n)
{
    ...
    for (int i = 0; i < (n >> 4); i++) {
        ...
        (void)(u = vmull_s16(   vld1_s16(a), vld1_s16(b))), (void)(a += 4), b += 4;
        (void)(u = vmlal_s16(u, vld1_s16(a), vld1_s16(b))), (void)(a += 4), b += 4;
        v = vpadalq_s32(v, u);
    ...
    for ( ; nc >= 4; nc -= 4, b -= 4) {
        ...
        for (int i=0; i < (n >> 4); i++ )
            for (int j = 0; j < 2; j++) {
                ...
                b1 = b0;
                (void)(b0 = vld1_s16(bn)), bn += 4;
                (void)(ax = vld1_s16(an)), an += 4;
